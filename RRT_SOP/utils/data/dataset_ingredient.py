...
def config():
    ...
    train_folder = 'G:/.shortcut-targets-by-id/1KDitLyQWMJXkAHUSZUHKMk4LKRh2iJ6E/small/train'
    test_folder = 'G:/.shortcut-targets-by-id/1KDitLyQWMJXkAHUSZUHKMk4LKRh2iJ6E/small/val'
